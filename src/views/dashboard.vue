...
<script setup>
import { getAnalyticOverview } from '@/api/admin'
...
const initConsultationChart = () =>{
  ...
  //获取数据
  const dailyTrend = Array.isArray(aiData.value.consultationStats?.dailyTrend)
